...
const emailTemplates = require('../helpers/email_templates');
...
exports.forgotPassword = async function (req, res) {
  try {
    ...
    const { textBody, htmlBody } = emailTemplates.passwordResetTemplate(otp);

    const response = await mailSender.sendMail(
      email,
      'Ecomly - Password Reset Verification Code',
      textBody,
      htmlBody
    );
